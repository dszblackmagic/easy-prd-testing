...
- Complete installation updates: `skills/self-update/SKILL.md`
...
- Easy PRD Testing Skill or Plugin version checks, updates, upgrades, or latest-release requests: follow `skills/self-update/SKILL.md`.
